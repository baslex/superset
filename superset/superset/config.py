...
SECRET_KEY = 'kasjhdig^%$WRDSFHD^&I*(()__)'
...
EXTRA_CATEGORICAL_COLOR_SCHEMES = [
    {
        ...
        "isDefault": True,
        "colors": [
    '#234d36', '#437458', '#7b9485', '#a1b9ab', '#d0dcd5',  # Природные оттенки
    '#7799BB', '#88AA77', '#552288', '#5AAA46', '#CC7788',  # Акцентные цвета
    '#EEDD55', '#9977BB', '#BBAA44', '#DDCCDD'              # Дополнительные оттенки
]
    }]
